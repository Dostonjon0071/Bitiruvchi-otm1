 ...
 <section class="text-gray-600 body-font">
  <div class="container px-5 py-24 mx-auto">
    <div class="flex flex-col text-center w-full mb-20">
      ...
      <p class="lg:w-2/3 mx-auto leading-relaxed text-base">Otm bitiruvchilari uchun web-texnologiyalar asosida  ma`lumotlarni boshqarish tizimini ishlab chiqish</p>
    </div>
    <div class="border-t border-gray-200 justifiy-center" >
      <div class="container px-5 py-8 flex flex-wrap mx-auto items-center">
        <div class="flex md:flex-nowrap flex-wrap justify-center items-end md:justify-start">
          <div class="relative sm:w-64 w-40 sm:mr-4 mr-2">
            <label for="footer-field" class="leading-7 text-sm text-gray-600">INN raqami bilan qidirish</label>
          ...
          <a href="tahrirlash" class="flex-box text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded">Tahrirlash</a>
          <p class="text-gray-500 text-sm md:ml-6 md:mt-0 mt-2 sm:text-left text-center">Hozirda qayerda ishlayapti
            <br class="lg:block hidden">ishi haqida ma`lumot
          </p>
        </div>
    <div class="flex flex-wrap -m-2">
      <div class="p-2 lg:w-1/3 md:w-1/2 w-full">
        <div class="h-full flex items-center border-gray-200 border p-4 rounded-lg">
          <img alt="team" class="w-16 h-16 bg-gray-100 object-cover object-center flex-shrink-0 rounded-full mr-4" src="./images/IMG_8451.jpg/80x80">
          <div class="flex-grow">
