                   ...
                   <div class="row">
                    <div class="col-md-3">
                        <div class="form-group" >
                            ...
                            <input style="background-color:#2A3038; color:white;" name="date" value="{{$department->created_at?? "not fount address"}}"  type="text" class="form-control" id="exampleInputEmail3" placeholder="address" >
                        </div>
                    </div>
                    <div class="col-md-9">
                        <div class="form-group" >
                            ...
                            <textarea id="description_uz" style="background-color:#2A3038; color:white; height: 100px;"  name="description" class="form-control" style="height: 80px">
                                {{$department->department?? "not discription"}}
                              </textarea>
                        </div>
                    </div>
                  </div>
