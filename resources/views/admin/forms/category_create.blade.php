                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input name="name_ru"  type="text" class="form-control" id="exampleInputName1" placeholder=" Category Name Ru" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            {{-- @dd($category) --}}
                            <label for="exampleInputName1"> Category Name Uz </label>
                            <input name="name_uz"  type="text" class="form-control" id="exampleInputName1" placeholder=" Category Name Uz" required>
                        </div>
                    </div>
                  </div>
                  <div class="row">
