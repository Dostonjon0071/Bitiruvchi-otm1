                ...
                @method('POST') --}}
                  ...
                  <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            {{-- @dd($user) --}}
                            <label for="exampleInputName1"> Pasport raqami  </label>
                            <input name="serias_number" value="{{$user->serias_number ?? "not email"}}"  type="text" class="form-control" id="exampleInputName1" placeholder=" Pasport raqami" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="exampleInputName1"> Bitirgan yili </label>
                            <input name="and_year" value="{{$user->date?? "not inn"}}" type="number" class="form-control" id="exampleInputName1" placeholder="Bitirgan yili " required>
                        </div>
                    </div>
                  </div>
                  <div class="row">
