...
<div class="page-header">
    <h3 class="page-title">Kafedradagi o`qituvchilar jadvali</h3>
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a  href="{{route('teacher.create')}}" class="badge badge-outline-success">Create New User</a></li>
      </ol>
    </nav>
</div>
<div class="row " >
